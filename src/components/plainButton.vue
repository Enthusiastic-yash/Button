...
const regularClasses = computed(() => {
  return {
    ...
    /*primary*/
    "text-blue-500 border-blue-500  hover:bg-blue-600 active:bg-blue-700 hover:text-white hover:drop-shadow-md":
      props.primary && !props.success && !props.warning && !props.critical,

    /*success*/
    "text-green-500 border-green-500  hover:bg-green-600 active:bg-green-700 hover:text-white hover:drop-shadow-md":
      props.success && !props.warning && !props.critical,
    /*Warning*/
    "text-amber-500 border-amber-500  hover:bg-amber-600 active:bg-amber-700 hover:text-white hover:drop-shadow-md":
      props.warning && !props.critical,
    /*Critical*/
    "text-rose-500  border-rose-500  hover:bg-rose-600 active:bg-rose-700  hover:text-white hover:drop-shadow-md ":
      props.critical,
    /*Block*/
    "w-full": props.block,
    /*size*/
...
const disabledClasses = computed(() => {
  return {
    /*default disabled*/
    "cursor-not-allowed disabled:text-neutral-300 disabled:hover:bg-inherit disabled:active:bg-inherit disabled:border-neutral-300 disabled:drop-shadow-sm":
      props.disabled &&
      !props.primary &&
      !props.success &&
      !props.warning &&
